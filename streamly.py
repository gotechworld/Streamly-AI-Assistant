...
st.set_page_config(
    ...
    menu_items={
        "Get help": "https://github.com/gotechworld/Streamly-AI-Assistant",
        "Report a bug": "https://github.com/gotechworld/Streamly-AI-Assistant",
        "About": """
...
def display_streamlit_updates():
    ...
    with st.expander("Streamlit 1.43.0 Announcement", expanded=False):
...
def initialize_conversation():
    ...
    conversation_history = [
        ...
        {"role": "system", "content": "You are trained up to Streamlit Version 1.43.0, release on March 4, 2025."},
...
def construct_formatted_message(latest_updates):
    ...
    if version_info:
        ...
        formatted_message.append(f"- **Version 1.43.0**: {description}")

    for category, updates in latest_updates.items():
        formatted_message.append(f"**{category}**:")
        for sub_key, sub_values in updates.items():
            if sub_key != "Version 1.43.0":  # Skip the version info as it's already included
